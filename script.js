...
const priorityKeywordsByLanguage = {
  en: new Set([
    ...
    "andrew", "believe", "bethany", "bethesda", "bethlehem", "bread",
    "caiaphas", "cana", "capernaum", "christ", "cross", "darkness", "david",
    "disciple", "disciples", "elijah", "ephraim", "eternal", "faith",
    "father", "galilee", "glory", "god", "golgotha", "grace", "heaven",
    "holy", "hour", "isaiah", "israel", "jerusalem", "jesus", "jews", "john",
    "jordan", "judea", "judas", "judgment", "kidron", "king", "kingdom",
    "lamb", "law", "lazarus", "life", "light", "lord", "love", "martha",
    "mary", "messiah", "miracle", "miracles", "moses", "nathanael",
    "nazareth", "passover", "peace", "peter", "pharisees", "philip",
    "pilate", "pray", "prophet", "rabbi", "resurrection", "sabbath",
    "salvation", "samaria", "scripture", "sea", "shepherd", "siloam",
    "sign", "signs", "simon", "sin", "sins", "son", "spirit", "sychar",
    "teacher", "temple", "testify", "testimony", "thomas", "tiberias",
    "truth", "vine", "water", "witness", "word", "world",
  ]),
  ko: new Set([
